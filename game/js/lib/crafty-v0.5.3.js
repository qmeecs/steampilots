...
Crafty.extend({
    ...
    * #Crafty.batchSprite
    * @category Graphics
    * @sign public this Crafty.batchSprite(String image_url, Array map)
    *
    * Generates components based on positions in a sprite image to be applied to entities.
    * The array must containt the list of all entities described as:
    * name: x,y,w,h
    *
    * The tiles CAN be of different sizes.
    * The x and y value in the array are the coordinates of the tile within the sprite.
    * 
    * added by Fausto Dassenno @ moonsubmarine limited
    */
    batchSprite: function (url , map) {
